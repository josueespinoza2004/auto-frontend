...
export function CarFormEdit() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    const token= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNzQ4MjI3OTU3LCJleHAiOjE3NDgyMzUxNTd9.CoOnyQytjjtzf0LVD7Ks-VDU7AWNatim9hnTpEIpFmE"
    const formattedData = {
      ...data,token,
